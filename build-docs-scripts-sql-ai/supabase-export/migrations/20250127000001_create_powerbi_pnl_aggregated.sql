...
CREATE TABLE public.powerbi_pnl_aggregated (
...
CREATE TABLE public.powerbi_pnl_aggregated_subcategories (
    id uuid PRIMARY KEY DEFAULT uuid_generate_v4(),
...
CREATE INDEX idx_powerbi_pnl_aggregated_location_year_month ON public.powerbi_pnl_aggregated(location_id, year, month);
CREATE INDEX idx_powerbi_pnl_aggregated_subcategories_aggregated_id ON public.powerbi_pnl_aggregated_subcategories(aggregated_id);
CREATE INDEX idx_powerbi_pnl_aggregated_subcategories_main_category ON public.powerbi_pnl_aggregated_subcategories(main_category);
