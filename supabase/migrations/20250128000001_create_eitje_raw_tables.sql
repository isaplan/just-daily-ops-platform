...
CREATE TABLE IF NOT EXISTS public.eitje_time_registration_shifts_raw (
...
CREATE TABLE IF NOT EXISTS public.eitje_planning_shifts_raw (
    id SERIAL PRIMARY KEY,
    eitje_id INTEGER NOT NULL,
    user_id INTEGER,
    team_id INTEGER,
...
CREATE TABLE IF NOT EXISTS public.eitje_revenue_days_raw (
    id SERIAL PRIMARY KEY,
    eitje_id INTEGER NOT NULL,
    environment_id INTEGER,
    date DATE NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.eitje_availability_shifts_raw (
    id SERIAL PRIMARY KEY,
    eitje_id INTEGER NOT NULL,
    user_id INTEGER,
    team_id INTEGER,
...
CREATE TABLE IF NOT EXISTS public.eitje_leave_requests_raw (
    id SERIAL PRIMARY KEY,
    eitje_id INTEGER NOT NULL,
    user_id INTEGER,
    team_id INTEGER,
...
CREATE TABLE IF NOT EXISTS public.eitje_events_raw (
    id SERIAL PRIMARY KEY,
    eitje_id INTEGER NOT NULL,
    environment_id INTEGER,
    date DATE NOT NULL,
...
CREATE INDEX IF NOT EXISTS idx_eitje_time_registration_shifts_raw_date ON public.eitje_time_registration_shifts_raw(date);
CREATE INDEX IF NOT EXISTS idx_eitje_time_registration_shifts_raw_environment ON public.eitje_time_registration_shifts_raw(environment_id);
CREATE INDEX IF NOT EXISTS idx_eitje_time_registration_shifts_raw_team ON public.eitje_time_registration_shifts_raw(team_id);
CREATE INDEX IF NOT EXISTS idx_eitje_time_registration_shifts_raw_user ON public.eitje_time_registration_shifts_raw(user_id);
CREATE INDEX IF NOT EXISTS idx_eitje_time_registration_shifts_raw_date_env ON public.eitje_time_registration_shifts_raw(date, environment_id);

-- Planning shifts raw indexes
CREATE INDEX IF NOT EXISTS idx_eitje_planning_shifts_raw_date ON public.eitje_planning_shifts_raw(date);
CREATE INDEX IF NOT EXISTS idx_eitje_planning_shifts_raw_environment ON public.eitje_planning_shifts_raw(environment_id);
CREATE INDEX IF NOT EXISTS idx_eitje_planning_shifts_raw_team ON public.eitje_planning_shifts_raw(team_id);
CREATE INDEX IF NOT EXISTS idx_eitje_planning_shifts_raw_user ON public.eitje_planning_shifts_raw(user_id);
CREATE INDEX IF NOT EXISTS idx_eitje_planning_shifts_raw_date_env ON public.eitje_planning_shifts_raw(date, environment_id);

-- Revenue days raw indexes
CREATE INDEX IF NOT EXISTS idx_eitje_revenue_days_raw_date ON public.eitje_revenue_days_raw(date);
CREATE INDEX IF NOT EXISTS idx_eitje_revenue_days_raw_environment ON public.eitje_revenue_days_raw(environment_id);
CREATE INDEX IF NOT EXISTS idx_eitje_revenue_days_raw_date_env ON public.eitje_revenue_days_raw(date, environment_id);

-- Availability shifts raw indexes
CREATE INDEX IF NOT EXISTS idx_eitje_availability_shifts_raw_date ON public.eitje_availability_shifts_raw(date);
CREATE INDEX IF NOT EXISTS idx_eitje_availability_shifts_raw_environment ON public.eitje_availability_shifts_raw(environment_id);
CREATE INDEX IF NOT EXISTS idx_eitje_availability_shifts_raw_team ON public.eitje_availability_shifts_raw(team_id);
CREATE INDEX IF NOT EXISTS idx_eitje_availability_shifts_raw_user ON public.eitje_availability_shifts_raw(user_id);

-- Leave requests raw indexes
CREATE INDEX IF NOT EXISTS idx_eitje_leave_requests_raw_date ON public.eitje_leave_requests_raw(date);
CREATE INDEX IF NOT EXISTS idx_eitje_leave_requests_raw_environment ON public.eitje_leave_requests_raw(environment_id);
CREATE INDEX IF NOT EXISTS idx_eitje_leave_requests_raw_team ON public.eitje_leave_requests_raw(team_id);
CREATE INDEX IF NOT EXISTS idx_eitje_leave_requests_raw_user ON public.eitje_leave_requests_raw(user_id);

-- Events raw indexes
CREATE INDEX IF NOT EXISTS idx_eitje_events_raw_date ON public.eitje_events_raw(date);
CREATE INDEX IF NOT EXISTS idx_eitje_events_raw_environment ON public.eitje_events_raw(environment_id);
CREATE INDEX IF NOT EXISTS idx_eitje_events_raw_date_env ON public.eitje_events_raw(date, environment_id);
